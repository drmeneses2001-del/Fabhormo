...
READINGS = [
    dict(id='read:miller2011', kind='revision',
         ...
         tags=['esteroidogénesis', 'enzimas', 'déficits'],
         summary='Revisión de referencia sobre la vía completa, la localización subcelular de cada '
                 'enzima, su expresión por tejido y los cuadros por déficit.'),
    ...
    dict(id='read:turcu2015', kind='revision',
         ...
         tags=['suprarrenal', 'hiperplasia suprarrenal congénita', '11-oxigenados'],
         summary='Esteroidogénesis suprarrenal por zonas y correlato con las formas de hiperplasia '
                 'suprarrenal congénita, incluidos los andrógenos 11-oxigenados.'),
    dict(id='read:speiser2018', kind='guia',
         ...
         tags=['21-hidroxilasa', 'guía clínica'],
         summary='Guía de práctica clínica para el diagnóstico, el cribado neonatal y el tratamiento '
    ...
    dict(id='read:payne2004', kind='revision',
         ...
         summary='Panorámica de las enzimas esteroidogénicas, con énfasis en la regulación de su '
                 'expresión y en las reacciones de conjugación.'),
]
...
# --------------------------------------------------------------------- enzimas ---
ENZYMES = [
    dict(id='enz:StAR', gene='STAR', es='Proteína StAR', en='Steroidogenic acute regulatory protein',
    ...
    dict(id='enz:CYP11A1', gene='CYP11A1', es='Enzima de escisión de cadena lateral',
         ...
         note='Único paso comun a toda la esteroidogénesis: define la capacidad total de la célula.'),
    dict(id='enz:HSD3B2', gene='HSD3B2', es='3β-hidroxiesteroide deshidrogenasa tipo 2',
         ...
         activities=[dict(id='oxid', label='Oxidación 3β-OH e isomerización Δ5 a Δ4', cofactors=['NAD+'])],
         note='Isoforma de gónada y suprarrenal. Convierte la serie Δ5 en la serie Δ4.'),
    dict(id='enz:HSD3B1', gene='HSD3B1', es='3β-hidroxiesteroide deshidrogenasa tipo 1',
         ...
         activities=[dict(id='oxid', label='Oxidación 3β-OH e isomerización Δ5 a Δ4', cofactors=['NAD+'])],
         note='Isoforma de placenta y tejidos periféricos.'),
    dict(id='enz:CYP17A1', gene='CYP17A1', es='17α-hidroxilasa / 17,20-liasa',
         ...
         activities=[dict(id='hidroxilasa', label='17α-hidroxilacion', cofactors=['NADPH', 'POR']),
                     dict(id='liasa', label='Escisión 17,20 (requiere citocromo b5)',
                          cofactors=['NADPH', 'POR', 'CYB5A'])],
         note='Una sola proteína con dos actividades. La proporción entre ellas decide si la célula '
              'fabrica cortisol o andrógenos: el citocromo b5 inclina la balanza hacia la liasa.'),
    ...
    dict(id='enz:HSD17B3', gene='HSD17B3', es='17β-hidroxiesteroide deshidrogenasa tipo 3',
         ...
         activities=[dict(id='red', label='Reducción del 17-ceto a 17β-OH', cofactors=['NADPH'])],
         note='Isoforma testicular: es la que convierte androstenediona en testosterona en el testículo.'),
    dict(id='enz:AKR1C3', gene='AKR1C3', es='Aldo-ceto reductasa 1C3 (17β-HSD5)',
         ...
         activities=[dict(id='red', label='Reducción del 17-ceto a 17β-OH', cofactors=['NADPH'])],
         note='Versión periférica de la activación androgénica: piel, adiposo, próstata.'),
    dict(id='enz:HSD17B1', gene='HSD17B1', es='17β-hidroxiesteroide deshidrogenasa tipo 1',
         ...
         note='Granulosa y placenta: activa el estrógeno.'),
    ...
    dict(id='enz:CYP19A1', gene='CYP19A1', es='Aromatasa', en='Aromatase', corto='CYP19A1',
         ...
         activities=[dict(id='arom', label='Aromatización del anillo A con pérdida de C19',
                          cofactors=['NADPH', 'POR'])],
         note='Tres ciclos de hidroxilación que eliminan el carbono 19 y convierten el anillo A en fenol: '
              'es el único paso que transforma un andrógeno en estrógeno.'),
    dict(id='enz:SRD5A1', gene='SRD5A1', es='5α-reductasa tipo 1', en='5α-reductase type 1',
         corto='SRD5A1', family='SRD5A', compartment=REL,
         activities=[dict(id='red5a', label='Reducción del doble enlace Δ4', cofactors=['NADPH'])],
         note='Hígado, piel no genital y cerebro.'),
    dict(id='enz:SRD5A2', gene='SRD5A2', es='5α-reductasa tipo 2', en='5α-reductase type 2',
         corto='SRD5A2', family='SRD5A', compartment=REL,
         activities=[dict(id='red5a', label='Reducción del doble enlace Δ4', cofactors=['NADPH'])],
         note='Piel genital, próstata, epidídimo y folículo piloso: es la que fabrica DHT donde importa.'),
    dict(id='enz:AKR1C2', gene='AKR1C2', es='Aldo-ceto reductasa 1C2 (3α-HSD tipo 3)',
         ...
         activities=[dict(id='red3a', label='Reducción del 3-ceto a 3α-OH', cofactors=['NADPH'])]),
    dict(id='enz:HSD17B6', gene='HSD17B6', es='17β-HSD tipo 6 (RODH)', en='17β-HSD type 6',
         corto='HSD17B6', family='HSD', compartment=REL,
         activities=[dict(id='oxid3a', label='Oxidación 3α-OH a 3-ceto', cofactors=['NAD+'])]),
    dict(id='enz:SULT2A1', gene='SULT2A1', es='Sulfotransferasa 2A1', en='Sulfotransferase 2A1',
         ...
         activities=[dict(id='sulf', label='Sulfatación del 3β-OH', cofactors=['PAPS'])],
         note='Zona reticular de la suprarrenal e hígado: crea el reservorio circulante de DHEA-S.'),
    dict(id='enz:SULT1E1', gene='SULT1E1', es='Estrógeno sulfotransferasa', en='Estrogen sulfotransferase',
         corto='SULT1E1', family='SULT', compartment=CIT,
         activities=[dict(id='sulf', label='Sulfatación del fenol del anillo A', cofactors=['PAPS'])]),
    ...
    dict(id='enz:CYP21A2', gene='CYP21A2', es='21-hidroxilasa', en='Steroid 21-hydroxylase',
         ...
         note='Exclusiva de la corteza suprarrenal. Su déficit es la causa más frecuente de hiperplasia '
    ...
    dict(id='enz:CYP11B1', gene='CYP11B1', es='11β-hidroxilasa', en='Steroid 11β-hydroxylase',
         ...
         note='Zona fasciculada: último paso del cortisol.'),
    ...
    dict(id='enz:HSD11B2', gene='HSD11B2', es='11β-HSD tipo 2', en='11β-HSD type 2', corto='11β-HSD2',
         ...
         note='Protege al receptor mineralocorticoide del cortisol en riñón.'),
    dict(id='enz:CYP3A7', gene='CYP3A7', es='CYP3A7 (16α-hidroxilasa fetal)', en='Cytochrome P450 3A7',
         ...
         note='Hígado fetal: fabrica el precursor 16α-hidroxilado del estriol.'),
    dict(id='enz:CYP3A4', gene='CYP3A4', es='CYP3A4', en='Cytochrome P450 3A4', corto='CYP3A4',
         family='CYP', compartment=REL, electronDonor='POR',
         activities=[dict(id='oxid', label='Oxidación e inactivación hepática de esteroides y fármacos',
                          cofactors=['NADPH', 'POR'])]),
]
...
REACTIONS = [
    rx('rx:col_preg', 'mol:colesterol', 'mol:pregnenolona', 'enz:CYP11A1', 'escision_cadena',
       ...
       note='Tres oxidaciones sucesivas cortan la cadena lateral entre C20 y C22 y liberan '
            'isocaproaldehído. Es el paso limitante de toda la esteroidogénesis.'),
    ...
    rx('rx:17ohpreg_dhea', 'mol:17oh_pregnenolona', 'mol:dhea', 'enz:CYP17A1', 'escision_cadena',
       ...
       activity='liasa',
       note='En el ser humano la actividad liasa es mucho más eficiente sobre el sustrato Δ5: por eso '
            'la ruta hacia los andrógenos pasa por DHEA y no por 17-hidroxiprogesterona.'),
    ...
    rx('rx:17ohprog_a4', 'mol:17oh_progesterona', 'mol:androstenediona', 'enz:CYP17A1', 'escision_cadena',
       ...
       note='Paso poco eficiente en el ser humano: la 17-hidroxiprogesterona se acumula cuando la vía '
            'hacia el cortisol está bloqueada.', weight=0.3),
    ...
    rx('rx:t_dht', 'mol:testosterona', 'mol:dht', 'enz:SRD5A2', 'a5_reduccion', 'delta4', REL,
       ...
       alt=['enz:SRD5A1'],
       note='La 5α-reducción es irreversible y multiplica la potencia androgénica: la DHT se une al '
            'receptor con más afinidad y se disocia más despacio que la testosterona.'),
    ...
    rx('rx:dhea_16ohdhea', 'mol:dhea', 'mol:16oh_dhea', 'enz:CYP3A7', 'hidroxilacion', 'estrogeno',
       ...
       note='Ocurre en el hígado fetal: es el origen del estriol de la gestación.', weight=0.3),
    rx('rx:16ohdhea_e3', 'mol:16oh_dhea', 'mol:estriol', 'enz:CYP19A1', 'aromatizacion', 'estrogeno',
       REL, ['NADPH', 'POR'], ['tis:sincitiotrofoblasto'],
       note='Simplificación de la unidad fetoplacentaria: la placenta desulfata, oxida con 3β-HSD1 y '
    ...
    rx('rx:11oha4_11kt', 'mol:11oh_androstenediona', 'mol:11ceto_testosterona', 'enz:AKR1C3',
       ...
       source=TURCU,
       note='Simplificación de dos pasos: 11β-HSD2 oxida el 11β-OH a 11-ceto y AKR1C3 reduce el 17-ceto. '
            'La 11-cetotestosterona es un andrógeno potente de origen suprarrenal.', weight=0.5),
    ...
    rx('rx:17ohprog_17ohallo', 'mol:17oh_progesterona', 'mol:17oh_alopregnanolona', 'enz:SRD5A1',
       ...
       note='Simplificación de dos pasos: 5α-reducción por SRD5A1 y reducción 3α por AKR1C2.', weight=0.25),
    ...
    rx('rx:adiol_dht', 'mol:androstanodiol', 'mol:dht', 'enz:HSD17B6', 'otro', 'backdoor', REL,
       ...
       note='Cierra la vía alternativa: se llega a DHT sin pasar por testosterona.', weight=0.4),
    ...
    rx('rx:5adione_dht', 'mol:androstanodiona', 'mol:dht', 'enz:AKR1C3', 'reduccion_17ceto', 'backdoor',
       ...
       note='Vía de 5α-diona: en el cáncer de próstata resistente a la castración es la ruta dominante '
    ...
    rx('rx:prog_allo', 'mol:progesterona', 'mol:alopregnanolona', 'enz:SRD5A1', 'a5_reduccion',
       ...
       note='Simplificación de dos pasos (SRD5A1 y AKR1C2). La alopregnanolona es un neuroesteroide '
...
TISSUES = [
    tis('tis:leydig', 'Célula de Leydig', 'org:testiculo', 'Célula de Leydig', None,
        ...
        'Única fuente relevante de testosterona en el varon. Responde a LH con un aumento agudo del '
        'transporte de colesterol por StAR.'),
    tis('tis:teca', 'Célula de la teca', 'org:ovario', 'Célula de la teca interna', None,
        [('enz:StAR', 1), ('enz:CYP11A1', 1), ('enz:HSD3B2', 1), ('enz:CYP17A1', 1),
         ('enz:CYB5A', 0.5), ('enz:POR', 1), ('enz:HSD17B3', 0.5), ('enz:CYP19A1', 0),
         ('enz:CYP21A2', 0), ('enz:CYP11B1', 0)],
        ['mol:androstenediona', 'mol:testosterona'], ['LH'],
        'Mitad androgénica del folículo: fabrica el precursor que la granulosa aromatiza. No expresa '
        'aromatasa, así que por si sola no produce estrógeno.'),
    tis('tis:granulosa', 'Célula de la granulosa', 'org:ovario', 'Célula de la granulosa', None,
        ...
        'Mitad estrogénica del folículo: sin CYP17A1 no puede fabricar andrógenos, de modo que depende '
        'del sustrato que le llega de la teca. Es la teoria de las dos células.'),
    tis('tis:cuerpo_luteo', 'Cuerpo lúteo', 'org:ovario', 'Célula luteinica', None,
        ...
        'Tras la ovulación la maquinaria se reorienta hacia la progesterona, que prepara y mantiene el '
        'endometrio secretor.'),
    tis('tis:glomerulosa', 'Zona glomerular', 'org:suprarrenal', 'Célula de la zona glomerular', 'glomerulosa',
    ...
    tis('tis:fasciculada', 'Zona fasciculada', 'org:suprarrenal', 'Célula de la zona fasciculada', 'fasciculata',
        [('enz:StAR', 1), ('enz:CYP11A1', 1), ('enz:HSD3B2', 1), ('enz:CYP17A1', 1),
        ...
        'cadena lateral, de modo que la vía termina en cortisol.'),
    tis('tis:reticular', 'Zona reticular', 'org:suprarrenal', 'Célula de la zona reticular', 'reticularis',
        ...
        'Citocromo b5 alto y 3β-HSD2 baja: la combinación favorece la actividad liasa y desvía el flujo '
        'hacia DHEA y su sulfato. Es el sustrato bioquímico de la adrenarquia.'),
    tis('tis:sincitiotrofoblasto', 'Sincitiotrofoblasto', 'org:placenta', 'Sincitiotrofoblasto', None,
        ...
        'Tampoco expresa CYP17A1: no puede fabricar andrógenos y depende de los precursores '
        'sulfatados que le llegan del feto. Ese reparto de tareas es la unidad fetoplacentaria.'),
    tis('tis:adiposo', 'Tejido adiposo', 'org:adiposo', 'Célula estromal del adiposo', None,
        [('enz:CYP19A1', 1), ('enz:AKR1C3', 1), ('enz:HSD17B2', 0.5), ('enz:STS', 0.5), ('enz:SRD5A1', 0.5)],
        ['mol:estrona', 'mol:estradiol', 'mol:testosterona'], [],
        'Principal fuente de estrógenos tras la menopausia y en el varon: aromatiza los andrógenos '
    ...
    tis('tis:piel_genital', 'Piel genital', 'org:genitales_externos', 'Fibroblasto de la piel genital', None,
        ...
        'vida fetal.'),
    tis('tis:foliculo_piloso', 'Folículo piloso y glándula sebácea', 'org:piel', 'Unidad pilosebacea', None,
        [('enz:SRD5A1', 1), ('enz:SRD5A2', 0.5), ('enz:AKR1C3', 1), ('enz:CYP19A1', 0.5)],
        ['mol:dht'], [],
        'Explica el acné y el hirsutismo con andrógenos circulantes normales: la conversión local '
        'decide el efecto.'),
    tis('tis:prostata_estroma', 'Próstata', 'org:prostata', 'Célula estromal y epitelial prostática', None,
        [('enz:SRD5A2', 1), ('enz:SRD5A1', 0.5), ('enz:AKR1C3', 1), ('enz:HSD17B6', 0.5)],
        ['mol:dht'], [],
        'Concentra DHT muy por encima de la testosterona plasmática: es la diana clásica de los '
    ...
    tis('tis:mama_estroma', 'Estroma mamario', 'org:mama', 'Fibroblasto y adipocito mamario', None,
        ...
        'superiores a las plasmáticas en la posmenopausia.'),
    tis('tis:hepatocito', 'Hepatocito', 'org:higado', 'Hepatocito', None,
        ...
        'Inactiva y conjuga: define la vida media de las hormonas y de casi todos los fármacos '
    ...
    tis('tis:cerebro_glia', 'Sistema nervioso central', 'org:cerebro', 'Neurona y glia', None,
        ...
        'local participa en la diferenciación sexual del cerebro.'),
    tis('tis:hueso_osteoblasto', 'Hueso', 'org:hueso', 'Osteoblasto', None,
        [('enz:CYP19A1', 0.5), ('enz:AKR1C3', 0.5), ('enz:SRD5A1', 0.5)],
        ['mol:estradiol'], [],
        'El estradiol local, incluido el aromatizado a partir de andrógenos, es lo que cierra el '
        'cartílago de crecimiento en ambos sexos.'),
]
...
CONDITIONS = [
    cond('cond:def_21oh', 'Déficit de 21-hidroxilasa (forma clásica)',
         ...
         'Virilización de los genitales externos ya al nacimiento (clitoromegalia, fusión de labios), '
         'con útero y ovarios normales. Es la causa más frecuente de genitales ambiguos en el recien nacido 46,XX.',
         'Genitales masculinos normales al nacer; el riesgo dominante es la crisis de pérdida salina '
         'en las primeras semanas y, si no se trata, la pubertad precoz periférica.',
         ['Pérdida salina con hiponatremia, hiperpotasemia e hipovolemia en la forma perdedora de sal',
          'Hiperplasia suprarrenal por estímulo mantenido de ACTH',
         ...
         SPEISER,
         'El bloqueo desvía el flujo acumulado hacia la única salida libre, la vía androgénica: por eso '
         'la 17-hidroxiprogesterona sube y con ella los andrógenos.'),

    cond('cond:def_21oh_nc', 'Déficit de 21-hidroxilasa no clásico',
         ...
         'Presentación tardia con hirsutismo, acné, oligomenorrea e infertilidad; se confunde con '
         'sindrome de ovario poliquistico.',
         'Habitualmente asintomático; puede haber acné o pubarquia precoz.',
         ['Actividad enzimática residual suficiente para mantener cortisol y aldosterona normales',
          'Diagnóstico con 17-hidroxiprogesterona basal en fase folicular temprana y prueba de ACTH'],
         ['lab:17ohp', 'lab:testosterona'],
         'Tratamiento solo si hay síntomas: anticonceptivo combinado o antiandrógeno para el '
         'hiperandrogenismo, glucocorticoide a dosis bajas si se busca gestación.',
         SPEISER),

    cond('cond:def_11boh', 'Déficit de 11β-hidroxilasa', '11β-hydroxylase deficiency',
         ...
         [('mol:11_desoxicortisol', 'up2', True), ('mol:doc', 'up2', True),
          ...
          ('mol:aldosterona', 'down', False,
           ...
           'intacta y le llega más sustrato. En la clínica la aldosterona es baja: el exceso de '
           ...
           'regulación que el modelo topológico no contiene.')],
         'Virilización como en el déficit de 21-hidroxilasa, pero con hipertensión en vez de pérdida salina.',
         'Genitales normales al nacer, pubertad precoz periférica e hipertensión.',
         ['Hipertensión e hipopotasemia por acumulo de 11-desoxicorticosterona, que tiene actividad '
          'mineralocorticoide',
          'La renina está suprimida, al contrario que en el déficit de 21-hidroxilasa'],
         ['lab:11_desoxicortisol', 'lab:renina', 'lab:potasio'],
         'Glucocorticoide sustitutivo; el control de la hipertensión mejora al frenar la ACTH.',
         TURCU),

    cond('cond:def_17oh', 'Déficit de 17α-hidroxilasa/17,20-liasa',
         ...
         'Fenotipo femenino con infantilismo sexual: no hay estrógenos para desarrollar la mama ni '
         ...
         'testosterona; testículos intraabdominales o inguinales.',
         ['Hipertensión e hipopotasemia por exceso de desoxicorticosterona y corticosterona',
          'El cortisol es bajo pero la corticosterona compensa parcialmente su acción glucocorticoide'],
         ['lab:progesterona', 'lab:testosterona', 'lab:potasio', 'lab:renina'],
         'Glucocorticoide para frenar la ACTH y sustitución de esteroides sexuales acorde al sexo asignado.',
         MILLER),

    cond('cond:def_3bhsd', 'Déficit de 3β-hidroxiesteroide deshidrogenasa tipo 2',
         ...
         'Virilización leve, paradojica: el DHEA acumulado es un andrógeno debil pero se convierte en '
         'testosterona en tejidos periféricos.',
         'Virilización incompleta con hipospadias y micropene, porque el testículo no puede fabricar '
         'testosterona por la vía principal.',
         ['Pérdida salina frecuente',
          'La relación 17-hidroxipregnenolona / 17-hidroxiprogesterona muy elevada es la clave diagnóstica'],
         ['lab:17oh_pregnenolona', 'lab:dhea_s', 'lab:renina'],
         'Glucocorticoide y mineralocorticoide sustitutivos.',
         MILLER),

    cond('cond:def_star', 'Hiperplasia suprarrenal lipoidea (déficit de StAR)',
         ...
         'Genitales externos femeninos normales; la función ovarica puede aparecer en la pubertad antes '
         'de fallar, porque el ovario no ha acumulado ésteres de colesterol.',
         'Genitales externos femeninos pese al cariotipo 46,XY: sin esteroidogénesis testicular no hay '
         'virilizacion.',
         ['Insuficiencia suprarrenal grave desde el período neonatal con pérdida salina',
          'Acumulo de ésteres de colesterol que destruye la célula esteroidogénica (modelo de dos golpes)'],
         ['lab:cortisol', 'lab:renina', 'lab:dhea_s'],
         'Sustitución con glucocorticoide y mineralocorticoide de por vida y esteroides sexuales en la '
         'pubertad.',
         MILLER),

    cond('cond:def_por', 'Déficit de P450 oxidorreductasa', 'P450 oxidoreductase deficiency',
         'POR', 'enz:POR', AR,
         ...
         [('mol:17oh_progesterona', 'up', True), ('mol:pregnenolona', 'up', False),
          ('mol:cortisol', 'down', True,
           'El modelo lo compensa con el aumento de ACTH y lo deja en rango. En la práctica el '
           'cortisol basal puede ser normal pero la respuesta al estres está comprometida, que es '
           'lo que importa clinicamente.'),
          ('mol:androstenediona', 'down', False),
          ('mol:estradiol', 'down', False)],
         'Virilización fetal que no progresa tras el nacimiento, por acumulo de andrógenos de la vía '
         'alternativa durante la vida intrauterina; virilización materna en la gestación por déficit '
         ...
         'Glucocorticoide en situaciones de estres y sustitución sexual según el fenotipo.',
         MILLER),

    cond('cond:def_aromatasa', 'Déficit de aromatasa', 'Aromatase deficiency', 'CYP19A1',
         'enz:CYP19A1', AR,
         ...
         [('mol:estradiol', 'down2', True), ('mol:estrona', 'down2', False),
          ...
          ('mol:androstenediona', 'up2', False,
           ...
           'en rango. En la clínica suben las dos, porque la aromatasa es la única salida real de '
           'ambas hacia los estrógenos.')],
         'Virilización de los genitales al nacer y virilización materna durante la gestación; en la '
         ...
         'alteración del metabolismo lipidico e hidrocarbonado.',
         ['Demuestra que el cierre del cartílago de crecimiento depende del estrógeno también en el varon',
          'Estriol materno indetectable durante la gestación'],
         ['lab:estradiol', 'lab:testosterona', 'lab:fsh'],
         'Estrógeno sustitutivo, que normaliza la masa ósea y cierra el cartílago de crecimiento.',
         MILLER),

    cond('cond:def_5ar2', 'Déficit de 5α-reductasa tipo 2', '5α-reductase type 2 deficiency',
         'SRD5A2', 'enz:SRD5A2', AR,
         [('rx:t_dht', 0.05)],
         [('mol:dht', 'down2', True),
          ('mol:testosterona', 'flat', True,
           'El modelo predice un ascenso leve por represamiento. En la clínica la testosterona es '
           'normal o alta: lo diagnóstico no es su valor absoluto sino la relación '
           'testosterona / dihidrotestosterona.')],
         'Sin expresión clínica: la DHT no interviene en el desarrollo genital femenino.',
         'Genitales externos femeninos o ambiguos al nacer con estructuras wolffianas normales; en la '
         'pubertad se produce virilización por el ascenso de testosterona, con crecimiento del falo y '
         'cambio de la voz, sin desarrollo prostático ni barba densa.',
         ['La relación testosterona / dihidrotestosterona elevada tras estímulo con hCG es diagnóstica',
          'Separa con claridad las acciones de testosterona y de DHT en el desarrollo'],
         ['lab:testosterona', 'lab:dht'],
         'Decisión de sexo de crianza individualizada; DHT topica o sistémica en la infancia en casos '
         'seleccionados.',
         MILLER),

    cond('cond:def_17bhsd3', 'Déficit de 17β-hidroxiesteroide deshidrogenasa tipo 3',
         ...
         'Genitales externos femeninos al nacer en el 46,XY; virilización y a veces ginecomastia en la '
         'pubertad, cuando AKR1C3 periférica convierte la androstenediona acumulada.',
         ['La relación androstenediona / testosterona tras hCG es la prueba clave',
          'Se distingue del déficit de 5α-reductasa por la testosterona baja, no normal'],
         ['lab:testosterona', 'lab:androstenediona'],
         'Gonadectomia y sustitución hormonal, o sustitución androgénica, según el sexo de crianza.',
         MILLER),

    cond('cond:def_cyb5a', 'Déficit aislado de 17,20-liasa por déficit de citocromo b5',
         ...
         [('mol:dhea', 'down2', True), ('mol:androstenediona', 'down2', False),
          ...
          ('mol:17oh_pregnenolona', 'up', False,
           ...
           'flujo. La acumulación del sustrato inmediato de la liasa es, sin embargo, esperable.'),
          ('mol:cortisol', 'flat', False)],
         'Ausencia de vello sexual y de andrógenos suprarrenales.',
         'Virilización incompleta con cortisol conservado: demuestra que las dos actividades de CYP17A1 '
         'se pueden separar.',
         ['La metahemoglobinemia acompaña al déficit de citocromo b5',
          'El cortisol es normal porque la actividad hidroxilasa se conserva'],
         ['lab:dhea_s', 'lab:testosterona'],
         'Sustitución androgénica en la pubertad.',
         MILLER),
]
...
DRUG_BLOCKS = [
    dict(id='cond:blq_abiraterona', drug='drug:abiraterona', enzyme='enz:CYP17A1',
         ...
         note='Inhibidor irreversible de CYP17A1. Frena a la vez la hidroxilasa y la liasa, de modo que '
              'suprime los andrógenos suprarrenales y obliga a asociar un glucocorticoide para evitar el '
    ...
    dict(id='cond:blq_finasterida', drug='drug:finasterida', enzyme='enz:SRD5A2',
         ...
         note='Inhibe sobre todo la 5α-reductasa tipo 2; la dutasterida inhibe además la tipo 1 y baja '
              'más la DHT circulante.'),
    ...
    dict(id='cond:blq_metirapona', drug='drug:metirapona', enzyme='enz:CYP11B1',
         ...
         note='Acumula 11-desoxicortisol: es la base de la prueba clásica de reserva hipofisaria de ACTH.'),
    dict(id='cond:blq_ketoconazol', drug='drug:ketoconazol', enzyme='enz:CYP17A1',
         ...
         blocks=[('rx:col_preg', 0.4), ('rx:preg_17ohpreg', 0.3), ('rx:17ohpreg_dhea', 0.2),
                 ('rx:s_cortisol', 0.3)],
         note='Inhibidor poco selectivo de varios citocromos P450 esteroidogénicos; se usa para frenar '
    ...
    dict(id='cond:blq_osilodrostat', drug='drug:osilodrostat', enzyme='enz:CYP11B1',
         ...
         note='Inhibe 11β-hidroxilasa y aldosterona sintasa; el acumulo de precursores con actividad '
              'mineralocorticoide puede causar hipopotasemia e hipertensión.'),
]
...
SERIES_GROUPS = [
    ...
    dict(id='grp:delta4', label='Serie Δ4', color='fam-gestageno',
         description='La 3β-HSD oxida el 3β-hidroxilo e isomeriza el doble enlace: el esteroide pasa a '
                     'la serie activa.'),
    dict(id='grp:estrogeno', label='Estrógenos', color='fam-estrogeno',
    ...
    dict(id='grp:backdoor', label='Vía alternativa', color='fam-androgeno', collapsed=True,
         description='Ruta que llega a DHT sin pasar por testosterona, con 5α-reducción temprana.'),
    dict(id='grp:11oxo', label='Andrógenos 11-oxigenados', color='fam-androgeno', collapsed=True,
         description='Andrógenos potentes de origen suprarrenal, relevantes en hiperandrogenismo.'),
]
...
def validate(molecule_ids):
    ...
    for r in REACTIONS:
        ...
        if r['substrate'] not in LAYOUT or r['product'] not in LAYOUT:
            ...
            errors.append('%s: sin posición en el mapa %s' % (r['id'], missing))
    ...
    for t in TISSUES:
        ...
        for m in t['produces']:
            if m not in molecule_ids:
                errors.append('%s: molécula desconocida %s' % (t['id'], m))
    ...
    for c in CONDITIONS:
        ...
        for b in c['blocks']:
            if b['reaction'] not in reaction_ids:
                errors.append('%s: reacción desconocida %s' % (c['id'], b['reaction']))
        for lv in c['expectedLevels']:
            if lv['mol'] not in molecule_ids:
                errors.append('%s: molécula desconocida %s' % (c['id'], lv['mol']))

    for d in DRUG_BLOCKS:
        for rid, _ in d['blocks']:
            if rid not in reaction_ids:
                errors.append('%s: reacción desconocida %s' % (d['id'], rid))
    return errors
...
def main():
    ...
    pathway = dict(
        ...
        names={'es': 'Esteroidogénesis humana', 'en': 'Human steroidogenesis'},
